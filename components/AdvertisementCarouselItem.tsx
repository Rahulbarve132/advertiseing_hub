...
export const AdvertisementCarouselItem: React.FC<AdvertisementCarouselItemProps> = ({ campaign }) => {
  const [ref, inView] = useInView<HTMLDivElement>({ threshold: 0.5 });

  React.useEffect(() => {   
    if (inView) {
      fetch(`https://advertisemedia.onrender.com/api/campaigns/${campaign._id}/analytics`, {
        method: "PUT",
